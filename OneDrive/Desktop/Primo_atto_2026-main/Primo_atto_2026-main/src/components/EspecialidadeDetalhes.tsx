...
// Importamos o seu hook de conversão (ajuste o caminho se necessário)
...
export const EspecialidadeDetalhes = ({ id, onBack }: EspecialidadeDetalhesProps) => {
  ...
  const { trackWhatsAppClick } = useGoogleEvents(); // Inicializamos o hook
      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-xl">
          ...
          <div className="mt-10 pt-8 border-t border-gray-200">
            {/* Mudamos de <a> para <button> para garantir que a função de rastreio 
                seja executada antes da navegação do WhatsApp abrir 
            */}
            <button

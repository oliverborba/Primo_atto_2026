...
export const SEO_CONFIG = {
  ...
  siteDescription: 'Equipe multidisciplinar especializada em desenvolvimento infantil, TEA, fonoaudiologia, psicologia, musicoterapia e terapia ocupacional no Rio de Janeiro (Copacabana e Flamengo).',
  
  pages: {
    home: {
      title: 'Primo Atto Terapias - Desenvolvimento Infantil em Rio de Janeiro | TEA, Fonoaudiologia, Terapia Ocupacional',
      description: 'Primo Atto Terapias: Equipe multidisciplinar especializada em TEA, fonoaudiologia, psicologia infantil, musicoterapia e terapia ocupacional em Rio de Janeiro. Atendimento em Copacabana e Flamengo com profissionais qualificados.',
      keywords: 'terapia ocupacional Rio de Janeiro, fonoaudiologia infantil, psicologia infantil, musicoterapia criança, TEA autismo, Transtorno Espectro Autista, desenvolvimento infantil, Copacabana, Flamengo, terapias especializadas, intervenção precoce, integração sensorial',
      path: '/'
    },
    tea: {
